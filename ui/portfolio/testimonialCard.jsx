...
const TestimonialCard = ({ text, author }) => {
  return (
    <div className=" rounded-lg py-6 md:px-1">
      <div className="h-72 2xl:h-80 bg-white/5 rounded-2xl border border-white/10 p-4 md:px-6 md:py-4">
        <div className="flex flex-col justify-between items-stretch h-full">
          ...
          <div className="md:h-2/3 lg:h-1/2 items-start justify-end text-white flex flex-col space-y-4">
            <p className="text-[15px] sm:text-base text-base lg:text-lg 2xl:text-2xl">{text}</p>
