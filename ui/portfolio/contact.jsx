...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    { icon: Phone, value: "+92 300-6619281", href: "tel:+923006619281" },
    {
      icon: MapPin,
      value: "Faisalabad Punjab, Pakistan",
  ...
  return (
    <section
      id="contact"
      className="px-4 sm:px-6 md:px-12 lg:px-20 py-12 md:py-16"
    >
      <motion.div
        ref={ref}
        variants={containerVariants}
      ...
      >
        <motion.h2
          variants={itemVariants}
          className="text-2xl sm:text-3xl md:text-4xl font-bold text-start mb-10 md:mb-14"
        >
          <span className="text-limeYellow">Get In Touch</span>
          <motion.div
            variants={itemVariants}
            className="w-40 sm:w-52 md:w-60 mt-1 h-0.5 rounded-r-full bg-gradient-to-r from-limeYellow via-white/60 to-transparent"
          />
        </motion.h2>
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    href={info.href}
                    whileHover={{ scale: 1.02, x: 5 }}
                    className="flex items-center p-3 sm:p-4 border-b border-white/10 hover:bg-white/10 hover:rounded-t-2xl transition-colors duration-200"
                  >
                    <info.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#D1ED5D] mr-3 sm:mr-4" />
              ...
              >
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="p-2 sm:p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors duration-200"
                  >
                    <social.icon className="w-5 h-5 sm:w-6 sm:h-6 text-limeYellow" />
                  </motion.a>
                ))}
              </motion.div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              >
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full py-2.5 sm:py-3 border-b border-white/20 text-white placeholder-white/50 focus:outline-none"
              ...
              <motion.div variants={formItemVariants}>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-limeYellow focus:border-transparent transition-colors duration-200 resize-none"
                  placeholder="Tell me about your project or just say hello!"
                />
              </motion.div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.01, backgroundColor: "#d4e600" }}
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-limeYellow rounded-xl text-black font-semibold transition-colors duration-500"
              >
                <Send className="w-5 h-5" />
                <span>Send Message</span>
              </motion.button>
        ...
        <motion.div
          variants={itemVariants}
          className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10 text-center"
        >
